...
- (void)configCell:(UITableViewCell *)cell indexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == 0)
    {
        cell.textLabel.text = NSLocalizedString(@"Upgrade and Restore", nil);
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0)
    {
        return NSLocalizedString(@"Upgrade and Restore", nil);
    }
    else if (section == 1)
    {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
...
#endif
    {
        ...
        {
            #if FreeApp
            [socila sendFeedback:NSLocalizedString(@"Emoji Keyboard 2.9", nil) body:nil];
            #else
