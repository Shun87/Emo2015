...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ArtViewController *artCotentController = [[ArtViewController alloc] initWithNibName:@"ArtViewController" bundle:nil];
    artCotentController.showIndex = -1;
    artCotentController.title = @"Favorites";
...
#if DEBUG
    request.testDevices= @[@"612cc2ae233b6be1ac62cce0f6f26a434602f105"];
#endif
    return request;
}
