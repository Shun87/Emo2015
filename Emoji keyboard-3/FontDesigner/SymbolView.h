...
@interface SymbolView : UIView <UIScrollViewDelegate, HorizontalTableViewDataSource, UITableViewDelegate>
{
//    UIScrollView *scrollView;
    ...
    CustomSegmentCtrol *segment;
    HorizontalTableView *horiTableView;
}
