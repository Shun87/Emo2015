...
{
    if ([self.horizontalDataSource respondsToSelector:@selector(numberOfSectionsInTableView:)])
    {
        return [self.horizontalDataSource numberOfSectionsInTableView:tableView];
    }
    return 1;
}
